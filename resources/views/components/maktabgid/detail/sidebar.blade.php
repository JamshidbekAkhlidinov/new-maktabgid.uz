...
<aside class="detail-side">
    <div class="side-card">
        ...
        <button type="button" class="btn btn-ghost side-cta js-start-chat-btn" data-institution-id="{{ $school['id'] }}"><x-maktabgid.icon name="chat" :width="18" :height="18" /> Suhbat boshlash</button>
