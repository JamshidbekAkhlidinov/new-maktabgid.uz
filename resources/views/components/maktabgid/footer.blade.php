        ...
        <div class="foot-grid">
            <div>
                ...
                <div class="foot-social">
                    <a href="#" aria-label="{{ __('footer.social_telegram') }}"><x-maktabgid.icon name="send" :width="18" :height="18" /></a>
                    <a href="#" aria-label="{{ __('footer.social_website') }}"><x-maktabgid.icon name="globe" :width="18" :height="18" /></a>
                    <a href="#" aria-label="{{ __('footer.social_phone') }}"><x-maktabgid.icon name="phone" :width="18" :height="18" /></a>
                </div>
            </div>
            <div class="foot-col">
                <h3>{{ __('footer.col_catalog') }}</h3>
